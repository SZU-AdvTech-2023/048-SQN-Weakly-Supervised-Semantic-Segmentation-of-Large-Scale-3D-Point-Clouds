...
test_dataset = SemanticKITTILoader(FLAGS.test_area, FLAGS.labeled_point, FLAGS.gen_pseudo, FLAGS.retrain, 'test')
...
def test(dataset, gen_pseudo=False):
    ...
    while True:
        ...
        for batch_idx, batch_data in enumerate(test_dataloader):
            ...
            idx += 1
            # loss, end_points = compute_loss(end_points, cfg, device, False)
            ...
            # print('step' + str(idx) + ' acc:' + str(acc))
