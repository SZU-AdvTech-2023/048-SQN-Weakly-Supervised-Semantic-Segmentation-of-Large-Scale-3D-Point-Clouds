...
from SQN_data_aug import Network, compute_loss, compute_acc, IoUCalculator
...
log_string('Settings:')
log_string('augmentation version')
...
def train_one_epoch():
    ...
    adjust_learning_rate(optimizer, EPOCH_CNT)          # 学习率放这里试试
