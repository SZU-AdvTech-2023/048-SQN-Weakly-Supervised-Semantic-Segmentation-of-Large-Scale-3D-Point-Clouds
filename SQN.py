...
class Network(nn.Module):
    ...
    def forward(self, end_points, device, is_training):     # 先不加数据增强看看效果
        ...
        for i in range(self.config.num_layers):
            ...
            xyz, neigh_idx, sub_idx = end_points['xyz'][i], end_points['neigh_idx'][i], end_points['sub_idx'][i]    # 这里本来是要数据增强的
